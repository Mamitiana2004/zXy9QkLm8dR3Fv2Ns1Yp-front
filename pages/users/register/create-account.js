            ...
            <div className={style.container}>
                ...
                <div className={style.login_right}>
                    <div className={style.login_title_container}>
                        <span className={style.login_title}>{t("create_password")}</span>
                        <span className={style.login_title_label}>{t("you_are_almost_there")}</span>
                    </div>
                    ...
                    <div className={style.content}>
                        ...
                        <div className={style.form_group}>
                                <div className={style.form_group_input}>
                                    <span className={style.form_label}>{t("username")}</span>
                                    <input 
                                        ref={usernameInput}
                                        type="text"  

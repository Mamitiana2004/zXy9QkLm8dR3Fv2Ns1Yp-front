...
export default function handler(req, res) {
    const countryCodes = [
        ...
        { label: '+27 (South Africa)', value: '+27' },
        { label: '+28 (Equatorial Guinea)', value: '+28' }, // Note: Code used by other regions
        { label: '+290 (Saint Helena)', value: '+290' },
        { label: '+291 (Eritrea)', value: '+291' },
        { label: '+292 (South Sudan)', value: '+292' },
        { label: '+293 (Gibraltar)', value: '+293' },
        { label: '+294 (Guam)', value: '+294' },
        { label: '+295 (Aruba)', value: '+295' },
        { label: '+296 (Curacao)', value: '+296' },
        { label: '+297 (Bonaire)', value: '+297' },
        { label: '+298 (Faroe Islands)', value: '+298' },
        { label: '+299 (Greenland)', value: '+299' },
        { label: '+300 (Cyprus)', value: '+300' },
        { label: '+301 (Cyprus)', value: '+301' },
        { label: '+302 (Cyprus)', value: '+302' },
        { label: '+303 (Cyprus)', value: '+303' },
        { label: '+304 (Cyprus)', value: '+304' },
        { label: '+305 (Cyprus)', value: '+305' },
        { label: '+306 (Cyprus)', value: '+306' },
        { label: '+307 (Cyprus)', value: '+307' },
        { label: '+308 (Cyprus)', value: '+308' },
        { label: '+309 (Cyprus)', value: '+309' },
        { label: '+310 (Cyprus)', value: '+310' },
        { label: '+311 (Cyprus)', value: '+311' },
        { label: '+312 (Cyprus)', value: '+312' },
        { label: '+313 (Cyprus)', value: '+313' },
        { label: '+314 (Cyprus)', value: '+314' },
        { label: '+315 (Cyprus)', value: '+315' },
        { label: '+316 (Cyprus)', value: '+316' },
        { label: '+317 (Cyprus)', value: '+317' },
        { label: '+318 (Cyprus)', value: '+318' },
        { label: '+319 (Cyprus)', value: '+319' },
    ];
